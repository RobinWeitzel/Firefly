...
export default class RevenueAccountsScreen extends React.Component {
    ...
    newItem = show => {
        ...
        return (
            <TouchableOpacity style={{padding: 20, flexDirection: "row", justifyContent: "space-between"}} onPress={() => this.newOther(this.state.search, 'revenue')}>
